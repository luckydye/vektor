...
- Address helpers: `server/src/utils/documentAddress.ts`
- Remote URL discovery: `server/src/api/routes/url-metadata.ts`
- Canvas document references: `server/src/canvas/elements/documentLink.ts`
- Drag payload emitter: `server/src/editor/elements/page-target.ts`
