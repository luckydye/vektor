...
export function config() {
  ...
  return {
    ...
    OTEL_EXPORTER_OTLP_TRACES_ENDPOINT: process.env.WIKI_OTEL_EXPORTER_OTLP_TRACES_ENDPOINT,
    OTEL_EXPORTER_OTLP_METRICS_ENDPOINT: process.env.WIKI_OTEL_EXPORTER_OTLP_METRICS_ENDPOINT,
    OTEL_TRACES_SAMPLER: process.env.WIKI_OTEL_TRACES_SAMPLER || "parentbased_traceidratio",
    OTEL_TRACES_SAMPLER_ARG: process.env.WIKI_OTEL_TRACES_SAMPLER_ARG || "1",
    OTEL_METRICS_EXPORT_INTERVAL_MS: process.env.WIKI_OTEL_METRICS_EXPORT_INTERVAL_MS || "10000",
