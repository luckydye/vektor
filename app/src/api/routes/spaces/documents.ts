...
import { documentEtag } from "#api/conditional.ts";
import {
  badRequestResponse,
  forbiddenResponse,
  jsonResponse,
 ...
 * Create a document
 *
 * The id is minted here. A caller that needs to choose it — because it derives
 * the id from an identifier of its own — creates with `PUT` instead.
 *
 * @tag Documents
 * @jobToken
 * @body
