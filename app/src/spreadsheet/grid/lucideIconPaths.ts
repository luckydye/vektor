// Ported from IronCalc `components/WorksheetCanvas/lucideIconPaths.ts` at tag v0.8.3, MIT OR Apache-2.0.
...
export const ICON_PATH_SPECS: Record<string, IconPathSpec> = {
  ...
  // Filled triangles
  TriangleUpFilled: {
    paths: ["M13.73 4a2 2 0 0 0-3.46 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3Z"],
    fill: true,
  },
  TriangleDownFilled: {
    paths: ["M13.73 4a2 2 0 0 0-3.46 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3Z"],
