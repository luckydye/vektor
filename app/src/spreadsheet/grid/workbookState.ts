// Ported from IronCalc `components/workbookState.ts` at tag v0.8.3, MIT OR Apache-2.0.
  ...
  getEditingText(): string {
    ...
    if (cell) {
      ...
      if (str === "") {
        ...
        return cell.text.substring(0, cursorPos) + str + cell.text.substring(cursorPos);
      }
    }
    return "";
  }
