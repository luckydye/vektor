...
function render() {
  ...
  // `document-view` may not be upgraded here (the editor chunk loads lazily),
  // so attach the shadow root ourselves rather than waiting for the element.
