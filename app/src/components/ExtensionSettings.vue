  ...
  <div class="flex-1 flex flex-col">
    <div class="pt-6 space-y-4">
      ...
      <div v-else-if="allExtensions.length === 0" class="text-center py-8">
        ...
        <p class="text-size-small text-neutral">
          Upload a .zip extension package to get started
        </p>
      </div>
        ...
        <table class="min-w-full text-size-medium">
          ...
          <tbody class="divide-y divide-neutral-100">
            ...
            <tr v-for="ext in extensions" :key="ext.id" class="hover:bg-neutral-50">
              <td class="px-4 py-2.5">
                ...
                <div
                  ...
                  class="text-size-small text-neutral-500 mt-0.5"
                >
                  {{ ext.description }}
                </div>
              </td>
              ...
              <td class="px-4 py-2.5 whitespace-nowrap text-neutral-900 font-mono">
                {{ ext.version }}
              </td>
              <td class="px-4 py-2.5">
                <div class="flex flex-wrap gap-1">
                  ...
                  >
                  <span
                    v-if="!ext.entries.frontend && !ext.entries.view"
            ...
            <tr
              ...
              :key="item.id"
              class="bg-amber-50 hover:bg-amber-100"
            >
              <td class="px-4 py-2.5">
