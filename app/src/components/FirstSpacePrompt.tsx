...
export function FirstSpacePrompt() {
  ...
  async function checkForSpaces() {
    try {
      const [spaces, me] = await Promise.all([api.spaces.get(), api.users.me()]);
      setCanCreate(me.canCreateSpace);
            ...
            fallback={
              <div class="text-center">
                ...
                <p class="text-neutral">
                  You are not a member of any space, and your account is not permitted to
                  create one. Ask an administrator to add you to a space.
                </p>
              </div>
            }
          >
