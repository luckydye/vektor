  ...
  <div>
    ...
    <div class="h-60">
      ...
      <a-track v-else snap class="flex h-full w-full overflow-visible">
        ...
        >
          <div
            class="aspect-video rounded-xl border-2 border-dashed border-neutral-200 flex items-center justify-center group-hover:border-neutral-300 transition-colors"
          >
            <span
